...
public class UsuarioService {
	...
	/*
	 * Recebe como parametro o id do usuario que esta sendo editado,
	 * para fazer a busca no banco de dados, e um objeto Usuario
	 * com os dados editados. Dentro do metodo, usamos outro metodos 
	 * que acabmos de criar para pegar os dados editados do usuario
	 * passado como parametro e inserir no usuario que buscamos do banco 
	 * de dados.
	 */
